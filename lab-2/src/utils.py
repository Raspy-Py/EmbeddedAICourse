...
class Streamer(object):
    def __init__(self, host='10.42.0.1', w=256, h=256, fps=30, port=5000):
        gst_out = (
            f'appsrc ! videoconvert ! videoscale ! x264enc tune=zerolatency bitrate=2000 speed-preset=superfast ! '
...
#========================================================================================
# Helper class for reshaping and padding inputs and reverting this changes on postprocess
# from Rockchip's repo 'rknn_model_zoo:
# https://github.com/airockchip/rknn_model_zoo/blob/main/
#========================================================================================
